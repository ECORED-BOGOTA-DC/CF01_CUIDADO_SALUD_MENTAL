  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .col-12.bg-c3
        .px-4.pt-4.pb-4.pb-lg-0
          .row.align-items-center
            .col-lg-4.mb-4.mb-lg-0
              figure
                img(src='@/assets/curso/tema2/img2.svg', style="width: 220px" ,alt='Texto que describa la imagen').m-auto
            .col-lg-8
            ...
            .col-lg-4
              ol.lista-ol--cuadro.lista-ol.mb-0
                li 
                  .lista-ol--cuadro__vineta
                    span 6.
                  | Solución de problemas y desacuerdos.
                li 
                  .lista-ol--cuadro__vineta
                    span 7.
    ...
    TabsA.color-acento-contenido.mb-5(data-aos="fade-left")
      .tarjeta.color-acento-botones.p-4(titulo="Promoción de la salud mental")
        .row
          .col-lg-8.mb-4.mb-lg-0
            p Son las medidas planificadas para evitar el brote de la enfermedad, tales como la disminución de factores de riesgo y las dirigidas a parar su avance y mitigar sus consecuencias, una vez creadas.
            p Las estrategias a tener en cuenta son:
            ul.lista-ul.mb-0
              li.d-flex
                i.fas.fa-check(style="color: #FF8182")
                |
                p.mb-0 Detección temprana de riesgos de violencias, problemas y trastornos mentales.
              li.d-flex
                i.fas.fa-check(style="color: #FF8182")
                |
                p.mb-0 Primeros Auxilios Psicológicos e intervención en crisis.
              li.d-flex
                i.fas.fa-check(style="color: #FF8182")
                |
                p.mb-0 Educación en salud mental.
              li.d-flex
                i.fas.fa-check(style="color: #FF8182")
                |
      ...
      .tarjeta.color-acento-botones.p-4(titulo="Atención primaria en salud mental")
        .row
          .col-lg-8.mb-4.mb-lg-0
            p Es la respuesta a las obligaciones de atención al usuario, familias y comunidades. Según la Política Integral de Atención en Salud, la integralidad en la atención comprende la igualdad de trato y oportunidades en el acceso. 
        ...
        SlyderA(tipo="b")
          ...
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0
              ...
              p Los trastornos mentales más comunes son: la depresión, trastorno bipolar, esquizofrenia, epilepsia, consumo problemático de alcohol y otras sustancias psicoactivas, Alzheimer y otras demencias, trastornos por estrés postraumático, trastorno obsesivo compulsivo, trastorno de pánico e insomnio primario.
