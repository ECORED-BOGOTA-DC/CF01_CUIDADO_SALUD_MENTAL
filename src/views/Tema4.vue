...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Son aquellas características, variables o circunstancias que, cuando están presentes en una persona, hacen más probable que sufra un trastorno en comparación con otra persona que no los presenta. Los factores de riesgo pueden ser:
    .row.mb-5
      .col-lg.bg-c10.m-2
        .p-4
    ...
    p Provienen de las fallas en el diseño, el ordenamiento y la gestión del trabajo, así como de un limitado contexto social del trabajo, y pueden producir resultados físicos, sociales y psicológicos de forma negativa, como el agotamiento, la depresión y el estrés laboral.
    .row.align-items-center.mb-5
