      ...
      .row(titulo="Violencia psicológica")
        .col-12
          .row.align-items-center
            ...
            .col-lg-4
              figure
                img(src='@/assets/curso/tema6/img3.png', style="width: 500px" ,alt='Imagen decorativa').m-auto
      ...
      .row(titulo="Violencia económica y patrimonial")
        .col-12
          .row.align-items-center
            ...
            .col-lg-4
              figure
                img(src='@/assets/curso/tema6/img4.png', style="width: 500px" ,alt='Imagen decorativa').m-auto
      ...
      .p-4.p-lg-5
        SlyderA(tipo="b")
          .row.justify-content-center.align-items-center
            ...
            .col-lg-5
              figure
                img(src='@/assets/curso/tema6/img6.png', style="width: 500px" ,alt='Imagen decorativa').m-auto
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0
              p #[b Institucional]
            ...
            .col-lg-5
              figure
                img(src='@/assets/curso/tema6/img7.png', style="width: 500px" ,alt='Imagen decorativa').m-auto
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0
              p #[b Laboral]
          ...
          .row.justify-content-center.align-items-center
            ...
            .col-lg-5
              figure
                img(src='@/assets/curso/tema6/img9.png', style="width: 500px" ,alt='Imagen decorativa').m-auto
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0
              p #[b Obstétrica]
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-primario.p-5.h-100
          .tarjeta-numerada__numero
            .h2 1
          figure.mb-4
            img(src='@/assets/curso/tema6/img12.png', style="width: 60px" ,alt='Imagen decorativa')
      ...
      .col-md-6.col-xl.mb-4.mb-xl-0
        .tarjeta-numerada.color-acento-contenido.p-5.h-100
          .tarjeta-numerada__numero
            .h2 2
          figure.mb-4
            img(src='@/assets/curso/tema6/img13.png', style="width: 60px" ,alt='Imagen decorativa')
